...
public class WhenWorkingWithStrings {
    ...
    public void convertToLowerCase() {
        ...
        String lowerCaseTitle = bookTitle;
    ...
    public void convertToUpperCase() {
        ...
        String upperCaseTitle = bookTitle;
    ...
    public void replacingAText() {
        ...
        bookTitle = bookTitle.replace("Cat", "Dog");

        String updatedTitle = bookTitle;
